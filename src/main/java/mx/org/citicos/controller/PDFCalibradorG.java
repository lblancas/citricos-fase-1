...
public class PDFCalibradorG implements Runnable
{
	private int id=0;
	...
	public PDFCalibradorG(int id, int opcion, int usuario,String fileName) {
		super();
		this.id = id;
		this.opcion = opcion;
	...
	public void run()
    {
        System.out.println("Guarda>>>>>>>>>>>>>>>>>(corrida)>>>>>>>>>>>>>>>>>>>>> "+getId() );
